...
__ramfunc void k_queue_insert(struct k_queue *queue, void *prev, void *data)
{
	unsigned int key = irq_lock();
#if !defined(CONFIG_POLL)
	struct k_thread *first_pending_thread;
...
__ramfunc void k_queue_append(struct k_queue *queue, void *data)
{
