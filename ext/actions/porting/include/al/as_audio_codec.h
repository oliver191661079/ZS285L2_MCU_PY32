...
/*!
 * \brief
 *      ¶¨Òå½âÂëÊäÈë±ÈÌØÁ÷Êý¾Ý½á¹¹µÄÀàÐÍ
 */
typedef struct
{
    /*! ÊäÈë²ÎÊý£ºµ±Ç°ÊäÈë±ÈÌØÁ÷Ö¸Õë */
    unsigned char *bs;
    /*! ÊäÈë²ÎÊý£ºµ±Ç°ÊäÈë±ÈÌØÁ÷µÄ³¤¶È */
    short len;
    /*! ÊäÈë²ÎÊý£ºµ±Ç°ÊäÈë±ÈÌØÁ÷µÄÎ»¿í£¬8 or 16 */
    short bps;
    /*! Êä³ö½á¹û£ºµ±Ç°Ö¡ÏûºÄµÄ±ÈÌØÁ÷³¤¶È */
    short consumed;
    /*! Ô¤Áô */
    short reserve0;
} asin_bs_t;
...
/*!
 * \brief
 *      ¶¨Òå±àÂëÊä³ö±ÈÌØÁ÷Êý¾Ý½á¹¹µÄÀàÐÍ
 */
typedef struct
{
    /*! Êä³ö²ÎÊý£ºµ±Ç°Êä³ö±ÈÌØÁ÷Ö¸Õë */
    unsigned char *bs;
    /*! Êä³ö²ÎÊý£ºµ±Ç°Êä³ö±ÈÌØÁ÷µÄ³¤¶È */
    short len;
    /*! Î´Ê¹ÓÃ */
    short bps;
    /*! Î´Ê¹ÓÃ */
...
int32_t as_decoder_format_check(void *storage, char *extension, char *share_buf_1k);
 ...
 * @return type of asdec_ret_t
 */
int audio_decoder_ops_act(void *hnd, asdec_ex_ops_cmd_t cmd, unsigned int args);
...
typedef int (*audio_parser_ops_t)(void *hnd, asparse_ex_ops_cmd_t cmd, unsigned int args);
/**
 ...
 * @return type of audio_parser_ret_t
 */
int as_parser_ops_w13(void *hnd, asparse_ex_ops_cmd_t cmd, unsigned int args);
 ...
 *
 * @param handle handle of aac parser
 * @param cmd operation cmd, type of asparse_ex_ops_cmd_t
 * @param args args of parser parama addr
 *
 * @return 0: parser ok ,others failed audio_parser_ret_t
 */
int as_parser_ops_a13(void *handle, asparse_ex_ops_cmd_t cmd, unsigned int args);
