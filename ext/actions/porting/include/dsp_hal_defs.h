...
struct resample_aps2_params {
	uint32_t *step;
	uint32_t *state;
	int64_t *change_samples;
	RINGBUF_TYPE resbuf2;
}__packed;
...
struct decoder_dspfunc_info {
	...
	struct resample_aps_params resample_aps_param;
	struct resample_aps_params resample_aps_param2;
} __packed;
