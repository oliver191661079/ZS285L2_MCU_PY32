...
#define USB_HOTPLUG_STACK_BSS _NODATA_SECTION(.usb.mass_storage1)

#define STACK_SZ	CONFIG_USB_HOTPLUG_STACKSIZE
#define THREAD_PRIO	CONFIG_USB_HOTPLUG_PRIORITY

static u8_t usb_hotplug_stack[CONFIG_USB_HOTPLUG_STACKSIZE]  __aligned(4) USB_HOTPLUG_STACK_BSS;
...
#ifdef CONFIG_USB_HOST
int usb_hotplug_host_plugin(void)
{
#ifdef CONFIG_USB_SUPPORT_VDD_ADJUST
#ifdef CONFIG_SOC_DVFS_DYNAMIC_LEVEL
	//soc_dvfs_set_level(SOC_DVFS_LEVEL_FULL_PERFORMANCE, "usb");
#endif
#endif
...
#ifdef CONFIG_USB_SUPPORT_VDD_ADJUST
#ifdef CONFIG_SOC_DVFS_DYNAMIC_LEVEL
	//soc_dvfs_unset_level(SOC_DVFS_LEVEL_FULL_PERFORMANCE, "usb");
#endif
#endif
...
void usb_hotplug_device_disable(void)
{
...
void usb_hotplug_device_enable(void)
{
#ifdef CONFIG_USB_HOTPLUG
...
{
	usb_hotplug_state = USB_HOTPLUG_NONE;
