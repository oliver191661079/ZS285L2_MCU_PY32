...
const uint8 MODEL_ID_ATS28xx[3] = {0x1E, 0x89, 0xA7};
const uint8 PRIVATE_ANTI_SPOOFING_KEY_ATS28xx[32] = {
...
extern void* fastpair_init(uint8* model_id, uint8 *spoofing_key)
{
    ...
    if(!model_id || !spoofing_key){
        handle = fast_pair(MODEL_ID_ATS28xx, PRIVATE_ANTI_SPOOFING_KEY_ATS28xx, bluetooth, storage, crypto);
    }
    else{
