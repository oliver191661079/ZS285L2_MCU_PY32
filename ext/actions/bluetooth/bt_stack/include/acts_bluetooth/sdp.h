...
#define BT_SDP_ATTR_L2CAP_PSM                   0x0200
...
/** @brief Get Vendor ID attribute value
 *
 *  Allows if exposed by remote retrieve  Vendor ID attribute.
 *
 *  @param buf Buffer holding original raw record data from remote.
 *  @param features On success object to be populated with  Vendor ID
 *  mask.
 *
 *  @return 0 on success if feature found and valid, negative in case any error
 */
...
/** @brief Get Product ID attribute value
 *
 *  Allows if exposed by remote retrieve  Product ID attribute.
 *
 *  @param buf Buffer holding original raw record data from remote.
 *  @param features On success object to be populated with  Product ID
 *  mask.
 *
 *  @return 0 on success if feature found and valid, negative in case any error
 */
...
/** @brief Set Color Id attribute value
 *
 *  Allows if exposed by remote retrieve
 */
