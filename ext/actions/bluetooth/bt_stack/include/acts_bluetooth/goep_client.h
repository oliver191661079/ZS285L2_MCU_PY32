...
struct bt_goep_header_param_ext {
	uint8_t id;
	uint16_t len;
	void* data;
};
...
int bt_goep_client_get_ext(struct bt_conn *conn, uint8_t goep_id, struct bt_goep_header_param_ext *param, uint8_t array_size);
