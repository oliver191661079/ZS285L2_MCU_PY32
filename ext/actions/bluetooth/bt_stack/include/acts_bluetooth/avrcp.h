...
enum {
	...
	BT_AVRCP_ATTRIBUTE_ID_COVER_ART    = 0x08,
};

enum {
	BT_AVRCP_TG_SUPPORT_CATEGORY1              = 0x01,
	BT_AVRCP_TG_SUPPORT_CATEGORY2              = 0x02,
	BT_AVRCP_TG_SUPPORT_CATEGORY3              = 0x04,
	BT_AVRCP_TG_SUPPORT_CATEGORY4              = 0x08,
	BT_AVRCP_TG_SUPPORT_PLAYER_APP_SETTING     = 0x10,
	BT_AVRCP_TG_SUPPORT_GROUP_NAVIGATION       = 0x20,
	BT_AVRCP_TG_SUPPORT_BROWSING               = 0x40,
	BT_AVRCP_TG_SUPPORT_MULTI_MEDIA_PLAYER_APP = 0x80,
	BT_AVRCP_TG_SUPPORT_COVER_ART              = 0x100,
};
...
#define TOTAL_ATTRIBUTE_ITEM_NUM   6
