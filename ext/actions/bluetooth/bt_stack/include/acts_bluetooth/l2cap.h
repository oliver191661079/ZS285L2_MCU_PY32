...
void bt_l2cap_br_fixed_chan_enable(uint8_t enable);

typedef int(*br_feature_fixed_chan_cb_t)(uint16_t handle);
void bt_l2cap_br_reg_feature_fixed_chan_cb_func(br_feature_fixed_chan_cb_t cb);
