...
#define BT_A2DP_LDAC_CODEC_LEN      10

#define BT_A2DP_VENDOR_LDAC			0x0000012D
#define BT_A2DP_CODEC_LDAC			0x00AA
...
enum {
	BT_A2DP_AAC_CHANNELS_1 = (0x1 << 3),
	BT_A2DP_AAC_CHANNELS_2 = (0x1 << 2),
};

enum {/* Octet6 */
    BT_A2DP_LDAC_SF_44100  = 0x20,
    BT_A2DP_LDAC_SF_48000  = 0x10,
    BT_A2DP_LDAC_SF_88200  = 0x08,
    BT_A2DP_LDAC_SF_96000  = 0x04,
    BT_A2DP_LDAC_SF_176400 = 0x02,
	BT_A2DP_LDAC_SF_192000 = 0x01,
};

enum {
	BT_A2DP_LDAC_CHANNELS_STEREO = (0x1 << 0),
	BT_A2DP_LDAC_CHANNELS_DUAL   = (0x1 << 1),
	BT_A2DP_LDAC_CHANNELS_MONO   = (0x1 << 2),
};
