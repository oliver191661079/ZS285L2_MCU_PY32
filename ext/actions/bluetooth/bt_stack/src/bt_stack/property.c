...
{
	return property_get_string(CFG_BLE_NAME, value, value_len, CONFIG_BT_DEVICE_NAME);
}

int bt_property_get_br_name(char *value, int value_len)
{
	return property_get_string(CFG_BT_NAME, value, value_len, CONFIG_BT_DEVICE_NAME);
}
/* Actiosn add end */