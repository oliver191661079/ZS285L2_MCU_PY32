...
#define CFG_BR_LEA_AUTOCONN_INFO	"BR_LEA_AUTOCONN_INFO"
...
#define CFG_OTA_POWER_LEVEL	"OTA_POWER_LEVEL"
...
#define CFG_BT_RF_TXPOWER           "BT_RF_TXPOWER"
#define CFG_BT_TEST_MODE            "BT_TEST_MODE"
#define CFG_BT_BIG_CH               "BT_BIG_CH"
...
#define CFG_BIN_TEST_ID				"BIN_TEST_ID"
...
#define CFG_LEA_VOLUME              "LEA_VOLUME"
#define CFG_BMR_VOLUME              "LE_VOLUME"  /* should be BMR_VOLUME*/
...
/**
 * @brief Obtaining integer value of target key
 *
 * @details get value by the target key, value format is integer .
 *
 * @param key string point of key
 * @param value point of return value
 * @param default_value default value if not found the key of target value
 ...
 * @param value point of return value
 * @param value_len  max length of value
 * @param def_value  default value of string
 *
 * @return <= 0  get failed
 * @return >0    string length of value
 */
 ...
 * @brief Obtaining value of target key
 *
 * @details get value by the target key, value format is hex string .
 *
 * @param key string point of key
 * @param value point of return value
 * @param value_len  max length of value
 ...
 * @brief Obtaining value of target key
 *
 * @details get value by the target key, value format is bool .
 *
 * @param key string point of key
 * @param value point of return value
 * @param default_value default value if not found the key of target value
 ...
 * @brief set value of target key
 *
 * @details set value by the target key, value format is bool .
 *
 * @param key string point of key
 * @param value bool type value want to set
 *
 * @return != 0  set failed
 * @return == 0  set success
 */
