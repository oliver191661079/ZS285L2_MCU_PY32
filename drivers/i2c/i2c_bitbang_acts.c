...
/* ~5 kHz: logic-analyzer friendly bus scan */
static const u32_t delays_scan_slow[] = {
	[T_LOW] = NS_TO_SYS_CLOCK_HW_CYCLES(100000),
	[T_HIGH] = NS_TO_SYS_CLOCK_HW_CYCLES(100000),
};
...
int i2c_bitbang_configure(struct i2c_bitbang *context, u32_t dev_config)
{
	...
	case I2C_SPEED_ULTRA:
		context->delays = delays_scan_slow;
		break;
	default:
		return -ENOTSUP;
	}
