...
static const ui_key_map_t usound_keymap[] = {
	{KEY_VOLUMEUP, KEY_TYPE_SHORT_UP | KEY_TYPE_LONG | KEY_TYPE_HOLD,
	 USOUND_STATUS_ALL, MSG_USOUND_PLAY_VOLUP},
	{KEY_VOLUMEDOWN, KEY_TYPE_SHORT_UP | KEY_TYPE_LONG | KEY_TYPE_HOLD,
	 USOUND_STATUS_ALL, MSG_USOUND_PLAY_VOLDOWN},
	{KEY_POWER, KEY_TYPE_SHORT_UP, USOUND_STATUS_ALL,
	 MSG_USOUND_PLAY_PAUSE_RESUME},
	{KEY_NEXTSONG, KEY_TYPE_SHORT_UP, USOUND_STATUS_ALL,
	 MSG_USOUND_PLAY_NEXT},
	{KEY_PREVIOUSSONG, KEY_TYPE_SHORT_UP, USOUND_STATUS_ALL,
...
static int usound_get_status(void)
{
